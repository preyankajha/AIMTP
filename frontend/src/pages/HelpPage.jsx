...
const faqs = [
  ...
  { q: 'Is this portal affiliated with Indian Railways?', a: 'No. This is an independent platform to help employees connect. All transfer approvals must go through official department channels.' },
];
...
const HelpPage = () => (
  <div className="animate-fade-in max-w-3xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
      <a
        href="mailto:support@railtransfer.in"
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[11px] font-medium text-slate-400 mt-0.5 truncate">support@railtransfer.in</p>
        </div>
    ...
    <div className="mt-8 bg-primary-50 border border-primary-100 rounded-[1.5rem] p-6">
      <p className="text-sm text-primary-800 font-medium">
        <span className="font-black">Developed by</span> Priyanka Jha · This platform is independently operated and not affiliated with Indian Railways.
      </p>
    </div>
  </div>
);
